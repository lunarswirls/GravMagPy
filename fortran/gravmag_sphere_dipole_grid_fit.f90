program gravmag_sphere_dipole_grid_fit
  ...
  character(len=1024), allocatable :: input_paths(:)
  integer(int32) :: input_count
  ...
  call split_path_list(trim(csv_list_arg), input_paths, input_count)
  call default_output_path(trim(input_paths(1)), pred_csv, '_dipole_fit_predictions.csv')
  call default_output_path(trim(input_paths(1)), dipole_csv, '_dipole_fit_dipoles.csv')
