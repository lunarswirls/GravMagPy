...
def main() -> int:
    ...
    ap.add_argument("html_file", nargs="?", help="Output HTML path; defaults to input-directory figs")
    ...
    html_path = Path(args.html_file) if args.html_file is not None else in_path.parent / "figs" / f"{in_path.stem}_3d.html"
