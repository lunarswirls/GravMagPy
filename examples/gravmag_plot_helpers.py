...
def plot_example(
    ...
    *,
    root_dir: Path | str = ".",
    examples_dir: str = "lunar_examples",
    ...
    output_root = root / output_dir if output_dir is not None else input_path.parent / "output"
    brtp_path = output_root / f"{example_stem}_brtp.txt"
