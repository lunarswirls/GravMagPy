...
This small configuration exercises report generation and solver orchestration. It is not a production threshold study; see [the full sweep](../hybrid_vertex_sweep/hybrid_vertex_sweep.md) for a broader geometry sample.
...
- detailed csv: `/Users/danywaller/code/GravMagPy/diagnostics/hybrid_vertex_sweep_smoketest/hybrid_vertex_sweep_detailed.csv`
- by-vertex csv: `/Users/danywaller/code/GravMagPy/diagnostics/hybrid_vertex_sweep_smoketest/hybrid_vertex_sweep_by_vertex.csv`
- plot: `/Users/danywaller/code/GravMagPy/diagnostics/hybrid_vertex_sweep_smoketest/hybrid_vertex_sweep.png`

## Methodology Note

This smoketest uses a tiny vertex set (`4,8`) to exercise pipeline mechanics, not to identify a stable production threshold.
